![Build Status](https://github.com/DiscipleTools/oneten-cities/actions/workflows/ci.yml/badge.svg?branch=master)

# Disciple.Tools - Oneten Cities
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```oneten_cities()```
...
[Issues](https://github.com/DiscipleTools/oneten-cities/issues) section of the repo. You can present ideas
in the [Discussions](https://github.com/DiscipleTools/oneten-cities/discussions) section of the repo. And
code contributions are welcome using the [Pull Request](https://github.com/DiscipleTools/oneten-cities/pulls)
system for git. For a more details on contribution see the
[contribution guidelines](https://github.com/DiscipleTools/oneten-cities/blob/master/CONTRIBUTING.md).
